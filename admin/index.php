...
if(isset($_POST['submit'])){
	...
	$sql=mysqli_query($con, "SELECT * FROM `administrator` WHERE `username`='$username' and `Password`='$password'");
...
if($num==1){
	...
	exit();
	//header('Refresh: 0; URL=http://localhost/techgadget/admin/change-password.php');
}
else
{
